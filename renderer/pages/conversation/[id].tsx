          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              {!generating ? 
                ...
                >
                  <svg className="w-4 h-4 fill-base-content" viewBox="0 0 24 24"><title>Auto-generate title</title><path fillRule="evenodd" d="M9 1a1 1 0 1 0-2 0v.5a1 1 0 0 0 2 0V1ZM3.7 2.3a1 1 0 0 0-1.4 1.4l1 1a1 1 0 0 0 1.4-1.4l-1-1Zm10 1.4a1 1 0 0 0-1.4-1.4l-1 1a1 1 0 0 0 1.4 1.4l1-1ZM1 7a1 1 0 0 0 0 2h.5a1 1 0 0 0 0-2H1Zm14 0a1 1 0 1 0 0 2h.5a1 1 0 1 0 0-2H15ZM4.7 12.7a1 1 0 1 0-1.4-1.4l-1 1a1 1 0 1 0 1.4 1.4l1-1ZM9 15a1 1 0 1 0-2 0v.5a1 1 0 1 0 2 0V15Zm.4-10a2 2 0 0 0-2.8 0L5 6.6a2 2 0 0 0 0 2.8l2.3 2.3L18.6 23c.8.8 2 .8 2.8 0l1.6-1.6c.8-.8.8-2 0-2.8L11.7 7.3 9.4 5Zm-3 3L8 6.4 9.6 8 8 9.6 6.4 8Zm3 3L11 9.4 21.6 20 20 21.6 9.4 11Z" clipRule="evenodd"/></svg>
                </button>
            ...
            <div className="flex flex-row items-center">
              ...
              <button 
                ...
                :
                <svg className="stroke-secondary-content fill-secondary" viewBox="0 0 24 24"><title>Delete Conversation</title><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16m-4 0-.27-.812c-.263-.787-.394-1.18-.637-1.471a2 2 0 0 0-.803-.578C13.938 3 13.524 3 12.694 3h-1.388c-.829 0-1.244 0-1.596.139a2 2 0 0 0-.803.578c-.243.29-.374.684-.636 1.471L8 6m10 0v10.2c0 1.68 0 2.52-.327 3.162a3 3 0 0 1-1.311 1.311C15.72 21 14.88 21 13.2 21h-2.4c-1.68 0-2.52 0-3.162-.327a3 3 0 0 1-1.311-1.311C6 18.72 6 17.88 6 16.2V6m8 4v7m-4-7v7"/></svg>
                }
                </span>
              </button>
